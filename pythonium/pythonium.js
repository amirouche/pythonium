...
var __int___rnotin__ = function(self, other) {
    /* BEGIN arguments unpacking */
    /* END arguments unpacking */
    /* BEGIN function */
    var call_arguments7 = [pythonium_get_attribute(other, "__notin__"), self];
    return pythonium_call.apply(undefined, call_arguments7);
};
__int___rnotin__.is_method = true;

var __int___neq__ = function(self, other) {
    /* BEGIN arguments unpacking */
    /* END arguments unpacking */
    /* BEGIN function */
    var call_arguments8 = [pythonium_get_attribute(self, "__eq__"), other];
    return pythonium_call(pythonium_get_attribute(pythonium_call.apply(undefined, call_arguments8), "__not__"));
};
...
var __list___notin__ = function(self, element) {
    /* BEGIN arguments unpacking */
    /* END arguments unpacking */
    var isin;
    /* BEGIN function */
    isin = (pythonium_get_attribute(element, "__rcontains__")(self));
    return pythonium_call(pythonium_get_attribute(isin, "__not__"));
};
__list___notin__.is_method = true;
